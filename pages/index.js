  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 1120, margin: "0 auto", paddingTop: 28 }}>
        ...
        {tab === "device" && (
          <div style={{
            ...
            {/* --- device content (оставь свой контент как есть!) --- */}
            {/* ... */}
          </div>
        )}
        ...
        {tab === "bulk" && (
          <div style={{
            ...
            {/* --- bulk content (оставь свой контент как есть!) --- */}
            {/* ... */}
          </div>
        )}
      ...
      <div style={{
        ...
        background: "#fff4e7",
        color: "#b45309",
        border: "1.2px solid #ffcc99",
        borderRadius: 9,
        fontSize: 13,
        fontWeight: 500,
        boxShadow: "0 4px 24px 0 rgba(246, 122, 38, 0.10)",
        padding: "10px 24px",
        zIndex: 5000
      }}>
        All processing is compliant with US, EU (GDPR), and UK data protection laws.
